                ...
                for (var key in response.data) {
                    ...
                    if (response.data.hasOwnProperty(key)) {
                        ...
                        objetos.forEach(function (element) {
                            var divData = $("<div>").attr("class", "filtersEach").attr("style", "display:inline-flex;width:50%;float: left;background-color:" + element.color+ ";color:"+element.text+";font-size: 16px;font-weight:bold;border-radius:20px;argin: 0.5vh 0vw;");

                            divData.append($("<input>").attr("type", "checkbox").attr("onclick", "filterAdd(" + element.id + ")").attr("name", element.name).attr("id", "checkBox-" + element.id).attr("style", "width:20%; background-color:" + element.color+";color:"+element.text+";font-size: 16px;font-weight:bold;border-radius:20px;argin: 0.5vh 0vw;"));
                            divData.append($("<label>").text(element.name).attr("styles", "width:80%;"));
            ...
            for (var key in response.data) {
                ...
                if (response.data.hasOwnProperty(key)) {
                    ...
                    objetos.forEach(function (element) {
                        ...
                        var divData = $("<div>").attr("class", "filtersEach").attr("style", "display:inline-flex;width:100%;background-color:" + element.color+";color:"+element.text+";font-size: 16px;font-weight:bold;border-radius:20px;margin: 0.5vh 0vw;","data-key", key);
        ...
        success: function (responseProduct) {
            ...
            getSession().then(function (session) {
                ...
                responseProduct.data.listImg.forEach(element => {
                    ...
                    divContentActions.append($("<button>").attr("type", "button").attr("class", "btn btn-danger").attr("onclick", "deleteDocsPro(\"" + element + "\"," + responseProduct.data.id + "," + 1 + ")").html("<i class=\"far fa-trash-alt\"></i>").addClass("noClose"));
